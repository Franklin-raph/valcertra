    ...
    <div>
      ...
      <section className='h-[70vh] pt-[2rem] header-bg'>
          ...
          <div className='text-center mt-[6rem] w-[65%] mx-auto  text-white'>
              <p className='text-[45px] font-bold mb-2'>  Africa's Seal of <span className='text-ascent-color'>Value</span> - Certified for Trade, Trusted Worldwide.</p>
      ...
      <section className='mt-[3rem]'>
        <p className='text-[#333333] text-center mb-[3rem] text-[26px]'>Certifying Africa's Industrial Leap</p>
        <div className='flex gap-[40px] justify-center px-[8rem]'>
          <div className='bg-[#D9D9D9] w-[50%]'></div>
          <div className='w-[50%] text-[#4D4D4D] font-[300]'>
            <p className='mb-[3rem]'>
      ...
      <section className='mt-[9rem]'>
        ...
        <div className='grid grid-cols-3 gap-[20px] px-[8rem] justify-center'>
          {
      ...
      <section className='mt-[9rem]'>
        <p className='text-[#333333] text-center mb-[0.3rem] text-[26px]'>How it Works</p>
        <p className='text-center mb-[1.5rem]'>Our streamlined process makes certification simple and efficient for businesses across Africa</p>
        <div className='flex gap-[80px] justify-center px-[8rem] mt-[3rem]'>
          <div className='grid grid-cols-2 gap-[50px] w-[90%]'>
            {
      ...
      <section className='mt-[9rem]'>
        <p className='text-[#333333] text-center mb-[3rem] text-[26px] font-[500]'>Why CERTIVIA</p>
        <div className='grid grid-cols-4 gap-[20px] px-[9rem] justify-center'>
          {
      ...
      <section className='mt-[9rem]'>
        <p className='text-[#333333] text-center mb-[3rem] text-[26px] font-[500]'>Our Partners</p>
        <div className='grid grid-cols-5 gap-[20px] px-[9rem] justify-center'>
          {
            [1,1,1,1,1].map(item => (
