...
export default function ValueAdditionCalculator({setValueAddedCalculator}) {
  ...
  return (
    <div>
        ...
        <div className="flex items-center flex-col text-center justify-center gap-3 bg-white fixed top-[50%] left-[50%] py-[20px] px-[0.5rem] z-[100] rounded-[8px] md:w-[500px] w-[95%]" style={{ transform: "translate(-50%, -50%)" }}>
        {/* Modal Header with back button and close button */}
        <div className="flex items-center justify-between px-2 mb-2 w-full">
            <div className="flex items-center">
                <button className="bg-blue-900 text-white rounded-md p-2 mr-4" onClick={() => { setValueAddedCalculator('') }}>
                    <IoArrowBackOutline />
                </button>
            </div>
        ...
        <div className="md:px-6 px-2 w-full">
            <div className='mb-[1.5rem]'>
                <div className="flex items-center justify-center mb-1 gap-2">
                    <IoCalculator className='text-primary-color text-[24px] hidden md:block'/>
                ...
                showFormula && (
                    <div className='w-full mx-auto'>
                        ...
                        <div className="mb-6 bg-secondary-color p-4 rounded w-full">
                            <p className='text-left text-[14px] text-[#666666] mt-3'>Value Addition = ((Local Inputs / Final Product Value) x 100)</p>
                        </div>
                    </div>
                )
            }
